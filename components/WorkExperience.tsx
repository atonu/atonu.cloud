...
const experiences = [
  {
    ...
    bullets: [
      ...
      'Technical manager, client-facing developer and front-end lead of blockchain based SaaS product with smart contracts',
      'Led technical optimization decision — migrated high-volume telemetry data from primary DB to cloud storage, significantly reducing costs',
      'Engineered LLM for localization capabilities',
      'Maintained clean coding, cache controlling, code reviewing, version controlling, script writing',
    ],
  },
  {
  ...
  },
  {
    ...
    flag: '🇩🇪',
    bullets: [
      'Developed maintainable template driven Angular components with lazy loaded modules and guarded routes',
      'Created APIs and data models with Go and MySQL',
      'File management with Amazon S3 via minIO',
      'Created FTP client with Go and integrated a German postal service API',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Increased flexibility and adaptability by working across different frameworks and infrastructures',
    ],
  },
];
        ...
        <div className={styles.header}>
          <div>
            ...
            <p className="section-subtitle">
              From Dhaka to Europe and the USA — building great software across borders
            </p>
          </div>
          {/* Superman Avatar */}
          <motion.div
            className={styles.supermanWrapper}
          ...
          >
            ...
            />
            <div className={styles.supermanBadge}>
              <span>⚡</span>
              <span>Super Engineer!</span>
            </div>
          </motion.div>
        </div>
